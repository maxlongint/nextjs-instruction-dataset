                ...
                >
                    <DialogHeader>
                        <DialogTitle className="flex items-center">
                            ...
                            提示词设置
                            {loadingCurrent && <FiLoader className="ml-2 h-4 w-4 animate-spin text-blue-500" />}
                        </DialogTitle>
                    </DialogHeader>
                    ...
                    <div className="flex flex-col space-y-4 flex-1 min-h-0">
                        ...
                        <div className="flex flex-col space-y-2">
                            ...
                            />
                            <div className="text-xs text-gray-500">字符数: {tempPrompt.length}</div>
                        </div>
                            ...
                            <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                                <div className="text-sm text-blue-800">
                                    ...
                                    <ul className="mt-2 space-y-1 text-xs">
                                        <li>
                                            • 使用 <code className="bg-blue-100 px-1 rounded">{'{content}'}</code>{' '}
                                            作为内容占位符，系统会自动替换为实际内容
                                        </li>
